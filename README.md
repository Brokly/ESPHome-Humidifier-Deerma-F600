...
Необязательно, только для новых версий устройств, коротые включатся левой кнопкой, а выбор режима производтся правой<br>
    <strong>disp_sync_pin: <br>
    sensor2_control_pin:  </strong><br><br> 
...
![схема_new](https://github.com/user-attachments/assets/20bb6010-ae2a-4351-81db-d70f61d33792)

Тут я нарисовал полную схему "допиливания", с указанием точек на фото выше. Для старых версий подклчение второго сенсора не нужно.
...
![image](https://github.com/Brokly/ESPHome-Humidifier-Deerma-F600/assets/11642286/fdbb4cf9-c146-43d5-b348-eb6692b9dd5b)
	Оптрон управления пищалкой. <strong>ВНИМАНИЕ !!! НОЖКИ ОПТРОНОВ ЗАГНУТЫ В ОБРАТНУЮ СТОРОНУ.</strong>
        Новая версия платы увлажнителя не отлчается от старой генерации. Тут просто показано как установить диод и конденсатор на второй сенсор. 
![image](https://github.com/user-attachments/assets/6af074ac-473f-4384-b909-0efc59c5d510)
